...
<div style="display: flex; align-items: center; justify-content: center; gap: 25px; flex-wrap: wrap; text-align: left;">
  <div style="flex: 1; min-width: 250px; max-width: 600px;">
    <p>
      ...
      <a href="https://chasacademy.se" target="_blank">Chas Academy</a>, focusing on 
      <strong>ASP.NET</strong>, <strong>API design</strong>, and <strong>modern web development</strong>.
    </p>
    <p>
      I like to learn from the things I build and see that as the reward for hard work.  
      One of my strengths (and weaknesses) is that I’m somewhat of a perfectionist — I don’t like to half-ass things.  
      You could say I’m a double-edged sword: I might slow down efficiency, but I always bring up the quality.
    </p>
    <p><em>"Fullstack isn't a title, it's a mindset."</em></p>
    <p>📫 Connect with me on <a href="https://www.linkedin.com/in/max-berglund04/">LinkedIn</a></p>
  </div>
  <div style="margin-left: 10px;">
    <a href="https://chasacademy.se" target="_blank">
      <img src="https://www.datocms-assets.com/91872/1675258709-footer_logo.svg" alt="Chas Academy" height="100"/>
    </a>
  </div>
</div>
...
Currently expanding my skills in **Rust** as part of my internship at **M8S**, focusing on system-level programming and performance optimization.
